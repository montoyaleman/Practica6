...
class catalogo : AppCompatActivity() {
    ...
    fun cargarSeries(){
        ...
        series.add((Pelicula("El monstruo de la Vieja Seul", R.drawable.demon, R.drawable.demo, "Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana.")))
