...
class catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas(){
        //peliculas.add((Pelicula("", R.drawable.demon, R.drawable.Demo, "")))
        ...
        peliculas.add((Pelicula("Héroe Por Encargo", R.drawable.demon, R.drawable.demo, "Un ex agente de las fuerzas especiales acepta un trabajo para brindar seguridad a una periodista mientras entrevista a un dictador, pero estalla un golpe militar en medio de la entrevista y se ven obligados a escapar a la jungla donde deben sobrevivir.", arrayListOf<Cliente>())))
    ...
    fun cargarSeries(){
        ...
        series.add((Pelicula("El monstruo de la Vieja Seul", R.drawable.demon, R.drawable.demo, "Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana.", arrayListOf<Cliente>())))
